...
public class RateCalculationServiceImpl implements RateCalculationService {
    ...
    private final OverpaymentCalculationServiceImpl overpaymentCalculationService;

    private final ResidualCalculationService residualCalculationService;

    private final ReferenceCalculationServiceImpl referenceCalculationService;
